                        ...
                        <div className="absolute top-8 left-10 z-10 p-4 md:p-8 lg:p-12">
                            ...
                            <div className="text-sm mt-12 ml-1">
                                <div className="w-[500px] lg:w-[700px] xl:w-[900px] mb-2">
                                    <h4>
                                        <strong>Bienvenue</strong> sur la
                                        nouvelle plateforme de Familles en
                                        affaires, une adaptation numérique et
                                        interactive de
                                        <em>
                                            {' '}
                                            L`&apos;`Album de familles et
                                            certaines données de l`&apos;`Indice
                                ...
                                <div className="mb-4 text-sm w-[500px] lg:w-[700px] xl:w-[900px]">
                                    <h4>
                                        ...
                                        façonnent l`&apos;`histoire et la
                                        culture de notre province. Grâce à son
                                        interface conviviale et ses
                                        fonctionnalités avancées, notre
                                        application permet aux utilisateurs de
                                        découvrir ces entreprises remarquables,
                                        d`&apos;`explorer leur histoire unique
                                        et de mener leurs propres
                                        investigations. Rejoignez-nous dans
                                        cette aventure captivante pour célébrer
                                        et soutenir l`&apos;`esprit
                                        d`&apos;`entreprise familial qui anime
                                        le Québec !{' '}
                                    </h4>
                                </div>
                            </div>
